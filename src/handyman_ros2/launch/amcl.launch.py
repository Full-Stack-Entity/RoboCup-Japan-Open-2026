...
"""AMCL launch — ROS 2 Humble
   ...
   AMCL is a lifecycle node — lifecycle_manager is required for autostart.
"""
...
def generate_launch_description():
    ...
    # AMCL is a lifecycle node — must be managed by lifecycle_manager to activate
    ...
    return LaunchDescription(args + [amcl_node, lifecycle_manager])
